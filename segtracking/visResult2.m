...
%         end
        ...
        imwrite(im2save,sprintf('data/vis0/s%02d-f%04d.png',sceneInfo.scenario,sceneInfo.frameNums(t)));
        %     end
    else
        lw=0; % in each dir
        for l=finallab
        ...
        imwrite(Ifin,sprintf('data/vis0/s%02d-f%04d.png',sceneInfo.scenario,sceneInfo.frameNums(t)));
    end
    pause(.01);
end