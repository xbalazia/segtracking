function [miss,roc,gt,dt] = acfTest_my(test, dataDir, varargin )
...
gt = loadGt(dataDir, setIds, vidIds, 30, pLoad, aspectRatio, [5 5 635 475]);
...
function gt = loadGt( dataDir, setIds, vidIds, skip, pLoad, aspectRatio, bnds )
