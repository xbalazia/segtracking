...
fs={'channels/convConst.cpp',...
  ...
  'images/ktComputeW_c.c',... % parse error
  'images/ktHistcRgb_c.c',... % parse error
  'images/histc2c.c',... % parse error
  'images/imtransform2_c.c',... % parse error
  'channels/gradientMex.cpp',... %C++ mex failed, likely due to lack of a C++ compiler.
  'detector/acfDetect1.cpp',... %C++ mex failed, likely due to lack of a C++ compiler.
  };
